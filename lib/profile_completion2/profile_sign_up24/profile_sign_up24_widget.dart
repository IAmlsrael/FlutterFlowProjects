...
import 'profile_sign_up24_model.dart';
export 'profile_sign_up24_model.dart';

class ProfileSignUp24Widget extends StatefulWidget {
  const ProfileSignUp24Widget({Key? key}) : super(key: key);

  @override
  _ProfileSignUp24WidgetState createState() => _ProfileSignUp24WidgetState();
}

class _ProfileSignUp24WidgetState extends State<ProfileSignUp24Widget> {
  late ProfileSignUp24Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileSignUp24Model());
  }
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (functions.checkBoolean(functions
                            ...
                            context.pushNamed('ProfileSignUp26');
                          } else {
