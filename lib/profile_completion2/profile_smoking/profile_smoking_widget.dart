...
import 'profile_smoking_model.dart';
export 'profile_smoking_model.dart';

class ProfileSmokingWidget extends StatefulWidget {
  const ProfileSmokingWidget({Key? key}) : super(key: key);

  @override
  _ProfileSmokingWidgetState createState() => _ProfileSmokingWidgetState();
}

class _ProfileSmokingWidgetState extends State<ProfileSmokingWidget> {
  late ProfileSmokingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileSmokingModel());
  }
