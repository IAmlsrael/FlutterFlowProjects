...
import 'profile_drinking_model.dart';
export 'profile_drinking_model.dart';

class ProfileDrinkingWidget extends StatefulWidget {
  const ProfileDrinkingWidget({Key? key}) : super(key: key);

  @override
  _ProfileDrinkingWidgetState createState() => _ProfileDrinkingWidgetState();
}

class _ProfileDrinkingWidgetState extends State<ProfileDrinkingWidget> {
  late ProfileDrinkingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileDrinkingModel());
  }
