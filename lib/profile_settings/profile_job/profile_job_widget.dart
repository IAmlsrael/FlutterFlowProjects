...
import 'profile_job_model.dart';
export 'profile_job_model.dart';

class ProfileJobWidget extends StatefulWidget {
  const ProfileJobWidget({Key? key}) : super(key: key);

  @override
  _ProfileJobWidgetState createState() => _ProfileJobWidgetState();
}

class _ProfileJobWidgetState extends State<ProfileJobWidget> {
  late ProfileJobModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileJobModel());
