...
import 'profile_covid_model.dart';
export 'profile_covid_model.dart';

class ProfileCovidWidget extends StatefulWidget {
  const ProfileCovidWidget({Key? key}) : super(key: key);

  @override
  _ProfileCovidWidgetState createState() => _ProfileCovidWidgetState();
}

class _ProfileCovidWidgetState extends State<ProfileCovidWidget> {
  late ProfileCovidModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileCovidModel());
  }
                      ...
                      children: [
                        Expanded(
                          child: wrapWithModel(
                            ...
                            updateCallback: () => setState(() {}),
                            child: UnderlineCircleCheckerWidget(
                              optionValue: 'Partially vacinated',
                            ),
                          ),
                        ),
                      ],
                      ...
                      children: [
                        Expanded(
                          child: wrapWithModel(
                            ...
                            updateCallback: () => setState(() {}),
                            child: UnderlineCircleCheckerWidget(
                              optionValue: 'Not yet vaccinated',
                            ),
                          ),
                        ),
                      ],
