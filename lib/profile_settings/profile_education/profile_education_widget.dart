...
export 'profile_education_model.dart';

class ProfileEducationWidget extends StatefulWidget {
  const ProfileEducationWidget({Key? key}) : super(key: key);

  @override
  _ProfileEducationWidgetState createState() => _ProfileEducationWidgetState();
}

class _ProfileEducationWidgetState extends State<ProfileEducationWidget> {
  late ProfileEducationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileEducationModel());
  }
