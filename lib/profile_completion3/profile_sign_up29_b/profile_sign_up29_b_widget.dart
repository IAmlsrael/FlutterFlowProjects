...
import 'profile_sign_up29_b_model.dart';
export 'profile_sign_up29_b_model.dart';

class ProfileSignUp29BWidget extends StatefulWidget {
  const ProfileSignUp29BWidget({Key? key}) : super(key: key);

  @override
  _ProfileSignUp29BWidgetState createState() => _ProfileSignUp29BWidgetState();
}

class _ProfileSignUp29BWidgetState extends State<ProfileSignUp29BWidget> {
  late ProfileSignUp29BModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfileSignUp29BModel());
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                ...
                                child: PromptAnswerBottomSheetWidget(
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                padding: MediaQuery.viewInsetsOf(context),
                                child: PromptAnswerBottomSheetWidget(
                                  question: _model.textController7.text,
                                ),
                              ),
                            );
                          },
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                padding: MediaQuery.viewInsetsOf(context),
                                child: PromptAnswerBottomSheetWidget(
                                  question: _model.textController9.text,
                                ),
                              ),
                            );
                          },
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                padding: MediaQuery.viewInsetsOf(context),
                                child: PromptAnswerBottomSheetWidget(
                                  question: _model.textController10.text,
                                ),
                              ),
                            );
                          },
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                padding: MediaQuery.viewInsetsOf(context),
                                child: PromptAnswerBottomSheetWidget(
                                  question: _model.textController11.text,
                                ),
                              ),
                            );
                          },
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                padding: MediaQuery.viewInsetsOf(context),
                                child: PromptAnswerBottomSheetWidget(
                                  question: _model.textController12.text,
                                ),
                              ),
                            );
                          },
                          ...
                          builder: (context) {
                            return GestureDetector(
                              ...
                              child: Padding(
                                padding: MediaQuery.viewInsetsOf(context),
                                child: PromptAnswerBottomSheetWidget(
                                  question: _model.textController13.text,
                                ),
                              ),
                            );
                          },
