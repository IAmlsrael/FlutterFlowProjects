...
import 'schema/likes_you_record.dart';
...
export 'schema/likes_you_record.dart';
...
/// Functions to query LikesYouRecords (as a Stream and as a Future).
Future<int> queryLikesYouRecordCount({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      LikesYouRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<LikesYouRecord>> queryLikesYouRecord({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      LikesYouRecord.collection(parent),
      LikesYouRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<LikesYouRecord>> queryLikesYouRecordOnce({
  DocumentReference? parent,
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
